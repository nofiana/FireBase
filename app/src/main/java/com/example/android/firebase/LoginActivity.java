...
import com.example.android.firebase.authentfikasi.LoginGoogleActivity;
import com.example.android.firebase.authentfikasi.LoginPhoneActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user!=null){
                    Toast.makeText(LoginActivity.this, "selamat anda berhasil login"+user.getEmail(), Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(LoginActivity.this,MainActivity.class));
                    finish();
                }else {
                    //Toast.makeText(LoginActivity.this, "gagal login\n periksa email anda untuk verifikasi", Toast.LENGTH_SHORT).show();
